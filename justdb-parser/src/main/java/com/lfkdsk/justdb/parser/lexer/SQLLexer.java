package com.lfkdsk.justdb.parser.lexer;
...
public class SQLLexer implements Lexer {
    private final Pattern regPattern = Pattern.compile(SQLRegex.hobbyReg);
    ...
    public SQLLexer(String program) {
